...
def getSTIXReport(global_scope, threat_type):
    ...
    if threat_type == "unauthorized_access":
        ...
        results = getSTIXReport_cryptomining(global_scope)
...
def getSTIXReport_cryptomining(global_scope):
    ...
    IoCSDO = stix2.v21.Indicator(indicator_types=["malicious-activity"],
                                ...
                                pattern=IoCPattern,
                                valid_from=timestamp_now,
                                name="Network activity related to cryptomining malware",
                                description="This traffic indicates the presence of a "
                                "cryptomining malware, which is producing network traffic",
                                #kill_chain_phases=kill_chain_phases,
                                labels= ["malicious-activity"])

    infraVictim = stix2.v21.Infrastructure(name = "Victim host",
                                        description = "The host mining crypto",
                                        infrastructure_types = ["workstation"])

    infraAttacker = stix2.v21.Infrastructure(name = "Attacker host",
                                        description = "The command and control server of the cryptimining malware campaign",
                                        infrastructure_types = ["command-and-control", "botnet"])
