...
TOPIC_RR_PROACTIVE_REMEDIATION = (os.environ['TOPIC_RR_PROACTIVE_REMEDIATION'])+"_rrtooldebug"
...
if (os.environ['KAFKA_DEBUG_TOPICS']):
    ...
    TOPIC_PORTAL_NOTIFICATIONS = TOPIC_PORTAL_NOTIFICATIONS+"_rrtooldebug"
    TOPIC_IR_INCIDENT_DETECTED = TOPIC_IR_INCIDENT_DETECTED+"_rrtooldebug"
# SC CONFIGURATION
